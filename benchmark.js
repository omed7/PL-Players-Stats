...
console.log(`Baseline Average Time (100 iterations, 100k players): ${avgTime.toFixed(2)} ms`);
...
console.log(`Optimized Average Time (100 iterations, 100k players): ${avgTimeOpt.toFixed(2)} ms`);
