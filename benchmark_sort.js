...
console.log(`Improvement: ${(((avgNameBaseline - avgNameOpt) / avgNameBaseline) * 100).toFixed(2)}%`);
...
console.log(`Improvement: ${(((avgMetricBaseline - avgMetricOpt) / avgMetricBaseline) * 100).toFixed(2)}%`);
